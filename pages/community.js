              ...
              >
                ...
                <div className="relative">
                  <div className="flex items-start justify-between mb-6">
                    <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-cyan-500/20 to-teal-500/20 flex items-center justify-center group-hover:scale-110 transition-transform">
                      <channel.icon className="w-7 h-7 text-cyan-400" />
                    </div>
                    <div className="flex items-center gap-2 px-3 py-1 rounded-full bg-cyan-500/10 border border-cyan-500/20 text-cyan-400 text-sm">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {events.map((event, index) => (
              ...
              >
                ...
                <button className="mt-6 w-full px-4 py-2 text-sm font-semibold text-slate-900 bg-gradient-to-r from-cyan-400 to-teal-400 hover:from-cyan-300 hover:to-teal-300 rounded-lg transition-all">
                  Register
                </button>
              </motion.div>
            ))}
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {ambassadors.map((ambassador, index) => (
              <motion.div
                ...
                transition={{ duration: 0.5, delay: index * 0.1 }}
                viewport={{ once: true }}
                className="bg-slate-800/50 rounded-2xl p-8 border border-white/10 hover:border-cyan-500/30 transition-all text-center"
              >
                <div className="w-20 h-20 rounded-full bg-gradient-to-br from-cyan-500/20 to-teal-500/20 flex items-center justify-center mx-auto mb-4">
                  <ambassador.avatar className="w-10 h-10 text-cyan-400" />
                </div>
                <h3 className="text-xl font-bold text-white mb-2">{ambassador.name}</h3>
                <div className="text-cyan-400 text-sm mb-4">{ambassador.role}</div>

          ...
          <div className="space-y-16">
            {features.map((feature, index) => (
              ...
              >
                ...
                <div className="flex-1">
                  <div className="bg-gradient-to-br from-cyan-500/10 to-teal-500/10 rounded-3xl p-8 border border-cyan-500/20 aspect-video flex items-center justify-center">
                    <feature.icon className="w-32 h-32 text-cyan-400/30" />
                  </div>
                </div>
              </motion.div>
            ))}
